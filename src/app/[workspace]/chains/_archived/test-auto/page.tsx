...
import ChainBuilderAutoAnimate from '@/components/chain-builder-auto-animate';

export default async function TestAutoAnimateChainPage({
  params
}: {
